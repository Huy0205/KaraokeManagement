...
public class LoaiPhongDaoIml extends UnicastRemoteObject implements LoaiPhongDAO {
	private static final long serialVersionUID = 1L;
	private final EntityManager em;

	public LoaiPhongDaoIml(String persistenceUnit) throws RemoteException {
	...
	public LoaiPhong getLoaiPhongByID(String maLoaiPhong) throws RemoteException {
		return em.createNamedQuery("LoaiPhong.findByID", LoaiPhong.class).setParameter("maLoaiPhong", maLoaiPhong)
				.getSingleResult();
	}
}
