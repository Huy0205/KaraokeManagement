...
import dao.impl.ChiTietPhieuDatDichVuDaoImpl;
import dao.impl.ChiTietPhieuDatPhongChoDaoImpl;
import dao.impl.ChiTietPhieuDatPhongDaoImpl;
...
public class Server {
	...
	public static void main(String[] args) {
		try {
			...
			ChiTietPhieuDatPhongChoDAO  chiTietPhieuDatPhongChoDAO = new  ChiTietPhieuDatPhongChoDaoImpl(PERSISTENCE_UNIT_NAME);
			ChiTietPhieuDatPhongDAO chiTietPhieuDatPhongDAO = new ChiTietPhieuDatPhongDaoImpl(PERSISTENCE_UNIT_NAME);
...
//			ChiTietPhieuDatDichVuDAO chiTietPhieuDatDichVuDAO = new ChiTietPhieuDatDichVuDaoImpl(PERSISTENCE_UNIT_NAME);
			...
			context.bind(URL + "ChiTietPhieuDatPhongChoDAO", chiTietPhieuDatPhongChoDAO);
			context.bind(URL + "ChiTietPhieuDatPhongDAO", chiTietPhieuDatPhongDAO);
